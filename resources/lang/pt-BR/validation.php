...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As mensagens de erro padrão usadas pela classe de validação.
    | Algumas regras possuem versões múltiplas, como as de tamanho.
    | Sinta-se livre para ajustar as mensagens aqui.
    |
    */
    ...
    'gte' => [
        ...
        'array' => 'O campo :attribute deve conter no mínimo :value itens.',
    ],
    ...
    | convenção "attribute.rule" para nomear as linhas. Isso facilita especificar mensagens específicas.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas abaixo são usadas para trocar o placeholder :attribute por algo mais amigável,
    | como "Endereço de E-Mail" ao invés de "email".
    |
    */
